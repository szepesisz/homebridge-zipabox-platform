...
class ZipAccessory{
  ...
  createService(type,name){
    ...
    switch(type){
      ...
      case "outlet":
        ...
        serviceToReturn = new Service.Outlet(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "temperature":
        ...
        serviceToReturn = new Service.TemperatureSensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "humidity":
        this.debug && this.log("[ZIPAC] [createService] Add a Humidity Sensor Accessory", this.debugContext);
        serviceToReturn = new Service.HumiditySensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "ambient":
        ...
        serviceToReturn = new Service.LightSensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "motion":
        ...
        serviceToReturn = new Service.MotionSensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "contact":
        ...
        serviceToReturn = new Service.ContactSensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "window":
        ...
        serviceToReturn = new Service.Window(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "door":
        ...
        serviceToReturn =  new Service.Door(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "covering":
        ...
        serviceToReturn =  new Service.WindowCovering(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "leak":
        ...
        serviceToReturn = new Service.LeakSensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "co2":
        ...
        serviceToReturn = new Service.CarbonMonoxideSensor(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "battery":
        ...
        serviceToReturn = new Service.BatteryService(name);
        if(name==this.name && type == this.type)
          this.basedService = serviceToReturn
        return serviceToReturn;
        break;
      case "alarm":
        ...
        serviceToReturn = new Service.SecuritySystem(name);
        /* StatusFault option :
        NO_FAULT = 0;
        GENERAL_FAULT = 1;*/
        this.statusFault = 0;
    ...
    switch(type){
      ...
      case "humidity":
        this.platformAccessory.getService(Service.HumiditySensor)
          ...
          .on('get', this.getOn.bind(this));
        if(fromCache)
          this.basedService = this.platformAccessory.getService(Service.HumiditySensor);
        break;
      case "ambient":
  ...
  */
  updatePolling(){
    ...
    if(this.platformAccessory.getService(Service.HumiditySensor))
      this.platformAccessory.getService(Service.HumiditySensor).getCharacteristic(Characteristic.CurrentRelativeHumidity).getValue();
  ...
  */
  getOn(callback,subService=null){
    /* DEBUG */
  ...
  */
  checkType(type){
    ...
    var isOk = false;
    var okStrings = ["switch","light","dimmer","outlet","temperature", "humidity", "ambient","motion","contact","window","door","covering","leak","co2","battery","alarm"];
